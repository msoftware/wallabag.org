...
[Six months ago, we released wallabag 2.0](https://www.wallabag.org/blog/2016/04/03/wallabag-v2). And exactly 3 years ago, we launched wallabag 1.0. A big step in our short life: we rewrote the whole application to propose to you many great features. And it was also easier for us to develop with the help of the Symfony framework.
...
di72nn worked really hard on the Android app and came out with the following new features :
...
![Android Sync](images/wllbg21/android_sync)
...
![Android Wizard](images/wllbg21/android_wizard)
